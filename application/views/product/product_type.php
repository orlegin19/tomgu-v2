<div class="col-lg-12">
    <div class="row">
        <div class="col-md-4">
            <button class="btn btn-sm btn-primary" type='button' id="new_pg"><i class='fa fa-plus'> Add product menu</i></button>
        </div>
    </div>
    <br>
    <div class="row">
...
<script>
    $(document).ready(function(){
        $('#new_pg').click(function(){
            AjaxUniModal(40,'<?php echo base_url().'popup/show_data/product/manage_pgroup/add' ?>','Add Product Menu');
        })
                    ...
                    var data = JSON.parse(resp);
                     ...
                     $('.edit_pg').each(function(){
                        $(this).click(function(){
                            ...
                            AjaxUniModal(40,url,'Edit Product Group')
                        })
                    })
