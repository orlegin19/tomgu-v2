...
<style>
  @media print {
    ...
    #header, #footers, #nav, .btn--call-to-action { 
...
<li class="nav-item <?php echo $product ?>  admin_only" >
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#products_collapse" aria-expanded="true" aria-controls="products_collapse" >
...
<li class="nav-item <?php echo $sales ?> " >
  ...
  <div id="sales_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item anc"  href="<?php echo base_url().'sales/pos' ?>">POS</a>
