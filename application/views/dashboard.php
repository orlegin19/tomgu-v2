<div class="col-md-12">
    ...
    <div class="card border-left-success shadow h-100 py-2">
        ...
        <div class="row no-gutters align-items-center">
            <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Unpaid Orders</div>
        ...
        success:resp=>{
            if(typeof resp != undefined && typeof resp != null){
                resp = JSON.parse(resp)
                    $('#sales_today').html('&#8369; '+parseFloat(resp.total_sales).toLocaleString('en-US',{style:'decimal', maximumFractionDigits:2}))
                    $('#total_unpaid').html('&#8369; '+parseFloat(resp.total_unpaid).toLocaleString('en-US',{style:'decimal', maximumFractionDigits:2}))
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: [resp.label[1],resp.label[2],resp.label[3],resp.label[4]],
    datasets: [{
      data: [resp.count[1],resp.count[2],resp.count[3],resp.count[4]],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc','#da7631'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf','#da7631'],
